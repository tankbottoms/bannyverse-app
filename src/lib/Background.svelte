...
>
	<defs>
		<style>
			@import url('https://gateway.pinata.cloud/ipfs/QmRodGNTG8Jex8nQQwufuNi4Brb4Cqy16YBJ3CKqBYfQKP/DM_Mono.css');
		</style>
		<filter id="f1">
			<feImage
				result="p0"
				xlink:href="data:image/svg+xml;base64,CiAgICAgICAgICA8c3ZnIHdpZHRoPScyOTAnIGhlaWdodD0nMjkwJyB2aWV3Qm94PScwIDAgMjkwIDI5MCcgeG1sbnM9J2h0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnJz4KICAgICAgICAgICAgPHJlY3Qgd2lkdGg9JzI5MHB4JyBoZWlnaHQ9JzI5MHB4JyBmaWxsPScjMTIzNDU2Jy8+CiAgICAgICAgICA8L3N2Zz4KICAgICAgICAgIA=="
			/>
			<feImage
				result="p1"
				xlink:href="data:image/svg+xml;base64,CiAgICAgICAgICA8c3ZnIHdpZHRoPScyOTAnIGhlaWdodD0nMjkwJyB2aWV3Qm94PScwIDAgMjkwIDI5MCcgeG1sbnM9J2h0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnJz4KICAgICAgICAgICAgPGNpcmNsZSBjeD0nMTkyJyBjeT0nMzYyJyByPScxMjBweCcgZmlsbD0nI2FiY2RlYScvPgogICAgICAgICAgPC9zdmc+CiAgICAgICAgICA="
			/>
			<feImage
				result="p2"
				xlink:href="data:image/svg+xml;base64,CiAgICAgICAgICA8c3ZnIHdpZHRoPScyOTAnIGhlaWdodD0nMjkwJyB2aWV3Qm94PScwIDAgMjkwIDI5MCcgeG1sbnM9J2h0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnJz4KICAgICAgICAgICAgPGNpcmNsZSBjeD0nMjQzJyBjeT0nMzYyJyByPScxMjBweCcgZmlsbD0nIzY3ODkwMScvPgogICAgICAgICAgPC9zdmc+CiAgICAgICAgICA="
			/>
			<feImage
				result="p3"
				xlink:href="data:image/svg+xml;base64,CiAgICAgICAgICA8c3ZnIHdpZHRoPScyOTAnIGhlaWdodD0nMjkwJyB2aWV3Qm94PScwIDAgMjkwIDI5MCcgeG1sbnM9J2h0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnJz4KICAgICAgICAgICAgPGNpcmNsZSBjeD0nMzcnIGN5PScxMzEnIHI9JzEwMHB4JyBmaWxsPScjZmFiY2RmJy8+CiAgICAgICAgICA8L3N2Zz4KICAgICAgICAgIA=="
			/>
		...
		<path
			id="text-path-a"
			d="M40 12 H250 A28 28 0 0 1 278 40 V250 A28 28 0 0 1 250 278 H40 A28 28 0 0 1 12 250 V40 A28 28 0 0 1 40 12 z"
		/>
	...
	<!-- <g clip-path="url(#corners)">
		<rect fill="123456" x="0px" y="0px" width="290px" height="290px" />
	...
	<!-- NOTE these are the three turning stars -->
